  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-xl font-semibold text-foreground mb-2">Análises Estatísticas</h3>
          <p className="text-muted-foreground">Visualizações avançadas com cálculos estatísticos detalhados</p>
        </div>

        {/* Gráfico de Média de Produção */}
        <ProductionAverageChart tasks={tasks} averageProduction={metrics.mediaProducao} />

        {/* Análise da Moda */}
        <ModeFrequencyChart tasks={tasks} mode={metrics.moda} />

        {/* Box Plot da Mediana */}
        <MedianBoxPlot tasks={tasks} median={metrics.mediana} />

        {/* Análise de Distribuição de Atrasos */}
        <DelayDistributionChart tasks={tasks} />
      </div>
    </div>
  );
}